...
from agentic_network.agents.topic_manager_cluster.agents.new_topic_agent.new_topic_agent import NewTopicAgent
...
if __name__ == "__main__":
    ...
    state = TopicManagerState(
        ...
        messages = [HumanMessage("I have a strong headache. What should i do?")],
        selected_agent = "",
    ...
    ai_message: AIMessage = final_state.get("messages")[-1]
